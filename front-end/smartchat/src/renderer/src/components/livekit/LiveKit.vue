...
let APPLICATION_SERVER_URL = 'http://localhost:3000/'
let LIVEKIT_URL = 'wss://smartchat-z7q3ud3z.livekit.cloud'
configureUrls()
...
onMounted(() => {
  // On component mounted, join the room
  joinRoom()
})
...
async function getToken(roomName: string, participantName: string) {
  ...
  return data.token
  // return "eyJhbGciOiJIUzI1NiJ9.eyJ2aWRlbyI6eyJyb29tSm9pbiI6dHJ1ZSwicm9vbSI6Im5hbWUtb2Ytcm9vbSIsImNhblB1Ymxpc2giOnRydWUsImNhblN1YnNjcmliZSI6dHJ1ZX0sImlzcyI6IkFQSTI2OEF5OEFNcU51aSIsImV4cCI6MTcyNzMwODExMCwibmJmIjowLCJzdWIiOiJ1c2VyLW5hbWUifQ.JHzFXa6hzdIWPqK1BlctfMtnE833dUMy1g3L-N2un7I"
}
</script>
