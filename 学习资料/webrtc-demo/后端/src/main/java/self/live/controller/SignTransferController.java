...
public class SignTransferController {
    private static final Logger log = LoggerFactory.getLogger(SignTransferController.class);
    ...
    public void addOfferIdentity(@RequestBody OfferIdentity offerIdentity) {
        ...
        log.info("offer信息"+offer);
        log.info("ice候选信息"+candidate);
